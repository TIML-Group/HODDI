...
# Import libraries for SMILES processing
...
class HeteroGNN(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.conv1 = HeteroConv({
            ('drug', 'interacts', 'drug'): GATConv(-1, hidden_channels, add_self_loops=False),
            ('drug', 'causes', 'side_effect'): GATConv(-1, hidden_channels, add_self_loops=False),
            ('side_effect', 'caused_by', 'drug'): GATConv(-1, hidden_channels, add_self_loops=False)
        })
        
        self.conv2 = HeteroConv({
            ('drug', 'interacts', 'drug'): GATConv(hidden_channels, hidden_channels // 2, add_self_loops=False),
            ('drug', 'causes', 'side_effect'): GATConv(hidden_channels, hidden_channels // 2, add_self_loops=False),
            ('side_effect', 'caused_by', 'drug'): GATConv(hidden_channels, hidden_channels // 2, add_self_loops=False)
        })
...
def train_model(data, model, device, train_periods, val_periods, test_periods,seed=seed):
    ...
    """
    save_dir = "model/GNN/hetero_GATConv/vanilla/"
    ...
    counter = 0
    min_delta = 0.001
    alpha = 1 # Balance between drug-drug and drug-side effect
    
    # Prepare CSV file
    current_time = datetime.now().strftime("%Y%m%d_%H%M%S")
    csv_file = os.path.join(save_dir, f"GATConv_vanilla_seed{seed}.csv")
...
def main():
    ...
    """
    Train a HeteroGNN model on the given data and hyperparameters.
    ...
    model : torch.nn.Module
        The HeteroGNN model to train.
    device : torch.device
        The device to use for training.
    train_periods : list
        The periods to use for training.
    val_periods : list
        The periods to use for validation.
    test_periods : list
        The periods to use for testing.
    ...
    # Data splitting
    train_periods = ['2015Q1', '2015Q2', '2015Q3', '2016Q4', '2017Q1', '2017Q2', '2017Q3', '2017Q4', '2018Q3', '2019Q1', '2019Q2', '2019Q3', '2019Q4', '2020Q1', '2020Q2', '2020Q3', '2020Q4', '2021Q1', '2021Q3', '2021Q4', '2022Q1', '2022Q2', '2022Q3', '2022Q4', '2023Q1', '2023Q2', '2023Q3', '2023Q4', '2024Q2']
    val_periods = ['2014Q3', '2015Q4', '2016Q1', '2016Q3', '2021Q2', '2024Q1']
    test_periods = ['2014Q4', '2016Q2', '2018Q1', '2018Q2', '2018Q4', '2024Q3']
